...
if [ "${TARGET_OS}" = "linux" -a "${TRAVIS_OS_NAME}" = "linux" ]; then
	...
	print_info "Updating apt cache"
	sudo apt-get -qq update
	print_info "Installing packages: mxe-i686-w64-mingw32.static-curl freetype hunspell jpeg libpng lcms1 pkg-config qt5 tiff"
	sudo apt-get install -y mxe-i686-w64-mingw32.static-curl mxe-i686-w64-mingw32.static-freetype mxe-i686-w64-mingw32.static-hunspell mxe-i686-w64-mingw32.static-jpeg mxe-i686-w64-mingw32.static-libpng mxe-i686-w64-mingw32.static-lcms1 mxe-i686-w64-mingw32.static-pkgconf mxe-i686-w64-mingw32.static-qt mxe-i686-w64-mingw32.static-tiff
	print_info "Building poppler"
	cd travis-ci
	env PATH="/usr/lib/mxe/usr/bin:$PATH" PREFIX="/usr/lib/mxe/usr" TARGET="i686-w64-mingw32.static" make -f build-poppler-mxe.mk
