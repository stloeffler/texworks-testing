...
if [ "${TARGET_OS}" = "linux" -a "${TRAVIS_OS_NAME}" = "linux" ]; then
	...
	echo_and_run "${MXEDIR}/usr/bin/${MXETARGET}-cmake .. \
		${CMAKE_OPTS} \
		-DQTPDF_ADDITIONAL_LIBS='harfbuzz;freetype;harfbuzz_too;freetype;wtsapi32;glib-2.0;intl;iconv;ws2_32;winmm;tiff;webp;jpeg;png;lcms2;lzma;bz2;pcre16;dwmapi;uxtheme;imm32' \
